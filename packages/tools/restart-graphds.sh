...
kill_all
( setsid nohup ${P2P_ROOT:-$HOME/p2p}/graphd/start.sh >> ${P2P_ROOT:-$HOME/p2p}/graphd/graphd.log 2>&1 < /dev/null & ) 
sleep 2
( setsid nohup ${D2D_ROOT:-$HOME/d2d}/graphd/start.sh >> ${D2D_ROOT:-$HOME/d2d}/graphd/graphd.log 2>&1 < /dev/null & )
